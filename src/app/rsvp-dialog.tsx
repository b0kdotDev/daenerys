      ...
      >
        ...
        {yes ? (
          ...
          <>
            ...
            <h2 className="font-serif mt-3 text-center text-2xl leading-snug text-[#8a3d5c] sm:text-3xl">
              Will you be ninong or ninang to our daughter, Brielle Daenerys?
            </h2>
            ...
            <form action={action} className="mt-8 space-y-5 text-left">
              ...
              <p className="-mt-3 text-[0.7rem] text-[#b56b86]">Email or phone — at least one.</p>
